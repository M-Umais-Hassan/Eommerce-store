        ...
        <div class="container">
            ...
            <form class='add-product' method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name='p_category' class="form-control form-control-md" required>
                    </div>
                </div><hr>
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if($pcat!=null){
            $query = "insert into product_categories(p_cat_name) values('$pcat')";
        ...
        if ($query) {
            ...
            echo "
            <script>
                window.open('admin_portal.php?insert_pcat','_self')
            </script>";
        }else{
            echo "
            <script>
